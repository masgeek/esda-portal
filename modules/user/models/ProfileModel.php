...
class ProfileModel extends UserProfile
{
    ...
    public function scenarios()
    {
        ...
        $scenarios[Constants::SCENARIO_SIGNUP] = ['USER_NAME', 'SURNAME', 'OTHER_NAMES', 'EMAIL_ADDRESS', 'INSTITUTION_ID', 'MEMBERSHIP_TYPE_ID', 'PASSWORD', 'REPEAT_PASSWORD'];//Scenario Values Only Accepted
    ...
    {
        return [
            [['USER_NAME', 'SURNAME', 'OTHER_NAMES', 'EMAIL_ADDRESS', 'INSTITUTION_ID', 'MEMBERSHIP_TYPE_ID', 'PASSWORD', 'REPEAT_PASSWORD'], 'required', 'on' => [Constants::SCENARIO_SIGNUP]],
            [['USER_NAME', 'SURNAME', 'OTHER_NAMES', 'EMAIL_ADDRESS', 'INSTITUTION_ID', 'MEMBERSHIP_TYPE_ID', 'PHONE_NUMBER'], 'required', 'on' => [Constants::SCENARIO_UPDATE]],
            [['EMAIL_ADDRESS'], 'email'],
